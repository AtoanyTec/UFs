# 🔁 Práctica 4: Control del Sentido de Giro de un Motor CD con Push Buttons y Sensor Infrarrojo
...
- Identifica claramente:
  ...
  - Pin de salida del sensor óptico
  - Alimentación del motor

⚠️ El circuito debe estar:
- Ordenado
- Sin falsos contactos
- Con cableado limpio y al ras del protoboard
...
| Integración del sensor óptico | Detención inmediata y consistente | Se detiene con ligero retraso | Detención inconsistente | No detiene |
