...
(x, y, \theta)
\]$
y representar su **diagrama cinemático** en **reposo** y en **t = 5 s**.
...
- Velocidad lineal: **v = 0.3 m/s**
- Ángulo de dirección: **δ = 0°**
- Distancia entre ejes: **L = 0.2 m**
- Condiciones iniciales:
  - $\(x(0)=0\)$
  - $\(y(0)=0\)$
  - $\(\theta(0)=0\)$

Posteriormente aumenta su velocidad a

- Velocidad lineal: **v = 0.7 m/s**
- Ángulo de dirección: **δ = 0°**

### ✅ Tu tarea
1. **Calcula** la postura final $\((x, y, \theta)\)$ en **t = 11 s**.
2. **Dibuja** el **diagrama cinemático** del robot:
   - Estado de **reposo** (t = 0)
   - Estado de **reposo** (t = 5)
   - Estado en **t = 11 s**
