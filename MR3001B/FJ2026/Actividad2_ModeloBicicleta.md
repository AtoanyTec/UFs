...
### 1️⃣ Primer tramo (Movimiento con giro)
- Tiempo: **2 segundos**
- Velocidad lineal: $\(v = 0.3\ \text{m/s}\)$
- Ángulo de dirección: $\(\delta = 5^\circ\)$

### 2️⃣ Segundo tramo (Movimiento recto)
- Tiempo: **10 segundos**
- Velocidad lineal: $\(v = 0.9\ \text{m/s}\)$
