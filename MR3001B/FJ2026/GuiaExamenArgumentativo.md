...
# 🔵 SECCIÓN I – 30 PREGUNTAS DE OPCIÓN MÚLTIPLE CON ARGUMENTACIÓN (40%)
...
### 2. Si $\( \omega_r > \omega_l \)$, el robot diferencial gira:
...
### 3.En el modelo bicicleta, el eje trasero se usa como referencia porque:

A) Es más estable mecánicamente  
B) No presenta deslizamiento lateral ideal  
C) Tiene menor velocidad  
D) Reduce consumo energético  
...
### 4. La velocidad angular del robot diferencial depende de:

A) Suma de velocidades  
B) Diferencia de velocidades  
C) Radio de giro  
D) Posición inicial  
...
### 5. En un robot oruga, el modelo cinemático es más similar a:

A) Modelo Ackermann  
B) Modelo diferencial  
C) Modelo esférico  
D) Sistema holonómico  
...
### 6. El parámetro $\( L \)$ afecta directamente:
...
### 7. Programar sin modelo cinemático formal afecta:

A) Solo consumo energético  
B) Robustez y repetibilidad  
C) Diseño mecánico  
D) Costo  
...
### 8. En un sistema mecatrónico integrado, el control depende de:

A) Solo software  
B) Solo sensores  
C) Interacción mecánica-electrónica-software  
D) Iluminación  
...
### 9. Una máquina de estados mejora el sistema porque:

A) Reduce consumo  
B) Ordena comportamiento lógico  
C) Simplifica mecánica  
D) Aumenta torque  
...
### 10. En control Go-to-Goal, el error principal es:
...
A) Solo código  
B) Modelo matemático  
C) Arquitectura completa del sistema  
D) Solo prototipo  
...
A) Mayor error  
B) Adaptabilidad  
C) Reducción de torque  
D) Eliminación de sensores  
...
A) Solo hardware  
B) Solo software  
C) Mecánica, electrónica, control y software  
D) Solo sensores  
